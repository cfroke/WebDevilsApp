 ...
 */
public class EmpRejectedConceptRecyclerViewAdapter extends RecyclerView.Adapter<EmpRejectedConceptRecyclerViewAdapter.ViewHolder> {

    private final LinkedList<Concept> mValues;
    private final EmpRejectedConceptListFragment.OnRejectedListFragmentInteractionListener mListener;
    public static Concept conceptUnderReview;
    View view;

    public EmpRejectedConceptRecyclerViewAdapter(LinkedList<Concept> items,
                                                 EmpRejectedConceptListFragment.OnRejectedListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.emp_list_rejected_item_card, parent, false);
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (null != mListener) {
                    ...
                    mListener.onRejectedConceptListFragmentInteraction(holder.mItem);
                }
            }
        });

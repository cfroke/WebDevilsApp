...
public class TestData {
    ...
    private void initializeTestData() {
        ...
        //Comment Data
        Concept bobComment = services.makeComment("I like the idea you have, nice thinking!!");
        Concept janeComment = services.makeComment("I really like the direction you went!!");
        Concept caseyComment = services.makeComment("Glad you chose that idea, hope they use it!!");
